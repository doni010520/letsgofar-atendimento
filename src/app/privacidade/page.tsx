...
export const metadata: Metadata = {
  title: "Política de Privacidade — Let's Go Far",
  description: "Política de Privacidade da plataforma de atendimento da Let's Go Far.",
};
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12 text-ink">
      <div className="mb-8 flex flex-col items-center text-center">
        ...
        <img src="/icon-512.png" alt="Let's Go Far" className="mb-4 h-16 w-16 rounded-2xl" />
      ...
      <div className="space-y-6 text-sm leading-relaxed text-ink-soft">
        <section>
          ...
          <p>
            A Let's Go Far (&ldquo;nós&rdquo;) opera uma plataforma de atendimento ao cliente que integra canais de
